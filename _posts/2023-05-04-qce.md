...
* Section 1.2 – Step-by-step code demonstration (Youzuo or Junhuan, 25 mins)
...
* Section 2.1 – Diffusion models (Junhuan, 15 mins) and Hybrid Model (Youzuo, 15 mins)
* Section 2.2 – Step-by-step code demonstration on edge device (Junhuan, 30 mins)
